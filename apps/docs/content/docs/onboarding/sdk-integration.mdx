...
1. **[Test Connection](/docs/onboarding/testing-connection)** - Verify tracking works
2. **[SDK Documentation](/docs/sdk)** - Learn about SDK features
3. **[Event Tracking](/docs/sdk/event-tracking)** - Track custom events
...
- [Testing Connection](/docs/onboarding/testing-connection) - Verify tracking
- [SDK Documentation](/docs/sdk) - Complete SDK guide
- [API Tokens](/docs/tokens) - Token management

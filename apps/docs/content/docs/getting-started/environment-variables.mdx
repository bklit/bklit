...
- Documentation: [Better Auth](https://www.better-auth.com/installation)
...
- Documentation: [Better Auth Google Guide](https://www.better-auth.com/authentication/google)
...
- Documentation: [Resend Docs](https://resend.com/introduction)

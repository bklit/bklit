...
Then fill in the required values. See the [Environment Variables](/getting-started/environment-variables) guide for details.
...
- [Database Setup](/getting-started/database-setup) - Detailed database configuration
- [Development](/getting-started/development) - Development workflow and tips

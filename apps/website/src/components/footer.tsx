    ...
    <div>
      ...
      <footer className="bg-background mt-auto">
        <div className="container mx-auto max-w-6xl flex flex-col gap-24 px-4">
          <div className="flex flex-col gap-6 text-center justify-center items-center bg-background bg-[radial-gradient(var(--color-zinc-800)_1px,transparent_1px)] bg-size-[10px_10px] p-32 border border-zinc-800">
            <h3 className="text-4xl font-bold bg-clip-text text-transparent bg-linear-to-b from-amber-100 to-emerald-100">
              Get started today
            </h3>
